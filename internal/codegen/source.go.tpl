...
{{range $structs}}
	...
	func (t {{capitalise .Name}}) CreateCommand() *model.CreateCommand {
		...
		{{else if or $field.IsEnum (eq $field.Type "GENMAP") (eq $field.Type "TEXTMAP") (eq $field.Type "MAP") (eq $field.Type "LIST") (eq $field.Type "NUMERIC") (eq $field.Type "DECIMAL")}}
